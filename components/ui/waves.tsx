...
// reactbits Waves — canvas perlin wave field. Verbatim, typed loosely.
...
export default function Waves({
  ...
  useEffect(() => {
    ...
    let frame = 0;
    const cfg = { lineColor, waveSpeedX, waveSpeedY, waveAmpX, waveAmpY, friction, tension, maxCursorMove, xGap, yGap };
    ...
    const moved = (p: any, withCursor = true) => ({
  ...
  return (
    <div
      ref={containerRef}
      className={className}
      style={{ position: "absolute", inset: 0, overflow: "hidden", backgroundColor }}
    >
