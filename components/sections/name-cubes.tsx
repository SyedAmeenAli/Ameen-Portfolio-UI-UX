  ...
  return (
    <section className="relative isolate overflow-hidden border-y border-steel/70 bg-ink py-[12vh]">
      <div aria-hidden className="absolute inset-0 -z-10 mx-auto max-w-5xl opacity-70">
        <Cubes gridSize={9} maxAngle={48} radius={3} faceColor="#0c0b0e" rippleColor="#800080" borderStyle="1px solid rgba(128,0,128,0.28)" />
      </div>
      ...
      <p className="pointer-events-none mt-4 text-center font-grotesk font-semibold text-[10px] uppercase tracking-[0.4em] text-yellow">
        Move the cursor
      </p>
    </section>
  );
