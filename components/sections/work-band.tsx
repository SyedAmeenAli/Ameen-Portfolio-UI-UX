...
/** Cat + statement band — the compact lower editorial strip. `quote` varies per page. */
export function WorkBand({ quote = "Same human · different ideas." }: { quote?: string }) {
