...
export const metadata: Metadata = { title: "2D Animations" };
...
export default function Motion2DPage() {
  return (
    <PageShell
      active="work" label="2D Animations"
      header={{ num: "09 / A", line1: "2D", line2: "Animations", sub: ["Kinetic type", "Loops", "Editorial transitions"], copy: "Short 2D pieces — type that moves, shapes with rules, brand motion." }}
    >
