  ...
  return (
    ...
    >
      <section className="flex flex-wrap gap-3 border-b border-purple/40 px-[4vw] py-4 font-grotesk text-[10px] font-semibold uppercase tracking-[0.18em]">
        <Link href="/work/motion/2d" className="border border-purple/40 px-4 py-2 text-bone hover:bg-purple hover:text-void">2D Motion ↗</Link>
        <Link href="/work/motion/3d" className="border border-purple/40 px-4 py-2 text-bone hover:bg-purple hover:text-void">3D Motion ↗</Link>
      </section>
