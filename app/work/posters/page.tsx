...
const NAMED: Record<string, { title: string; meta: string }> = {
  ...
  "astronaut-viewing-planet-poster": { title: "Orbital Memory", meta: "An archive of human dreams" },
  "collage-showing-404-error-doorway": { title: "404: Reality Not Found", meta: "Glitch / digital culture" },
  "glass-archival-drawer-with-dream": { title: "The Archive of Dreams", meta: "Memory / sleep / fragment" },
  ...
  "giant-eye-floating-above-city": { title: "Echoes of Tomorrow", meta: "Science fiction" },
