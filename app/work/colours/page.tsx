  ...
  return (
    <main className="relative bg-bone text-ink">
      ...
      <section className="on-dark grid-lines-dark border-y border-bone/10 px-[5vw] py-[16vh]">
        ...
        <p className="mt-8 max-w-[44ch] font-serif text-[clamp(1.1rem,2vw,1.6rem)] leading-snug text-bone/70">
      ...
      <section className="on-dark border-y border-bone/10 px-[5vw] py-[16vh]">
        ...
        <div className="mt-10 grid gap-1 sm:grid-cols-[6fr_3fr_1fr]">
          ...
          <div className="flex h-40 items-end bg-yellow p-4 font-mono text-[10px] uppercase tracking-[0.2em] text-ink">Accent</div>
        </div>
      ...
      <section className="px-[5vw] py-[18vh] text-center">
        ...
        <p className="mt-6 font-serif text-ink/60">Every palette has a purpose. Every colour has a role.</p>
