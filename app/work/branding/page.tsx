        ...
        <section key={b.slug} className="border-t border-steel/60 px-[3vw] py-[12vh]">
          <div className="mx-auto max-w-6xl">
            ...
            <figure className="mx-auto mt-12 max-w-3xl">
              <ZoomImage src={b.sketch} alt={`${b.name} exploration sketch`} caption={`${b.name} — exploration`} className="fibre border border-steel" />
              <figcaption className="mt-3 text-center font-mono text-[10px] uppercase tracking-[0.25em] text-concrete-dim">
            ...
            <div className="mt-16 grid gap-[5vh] lg:grid-cols-[minmax(0,1.5fr)_minmax(0,0.9fr)] lg:gap-[4vw]">
              <ZoomImage src={b.board} alt={`${b.name} brand system`} caption={`${b.name} — brand system`} className="fibre border border-steel lg:order-1" />
